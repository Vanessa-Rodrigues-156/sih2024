<template>
    ...
    <div class="min-h-screen bg-slate-900">
        ...
        <div class="flex justify-between items-center px-6 py-4 bg-slate-800">
            ...
            <router-link to="/"
                class="px-4 py-2 text-blue-400 border border-blue-400 rounded-md hover:bg-blue-400/10 transition-all">
                Back to Dashboard
            </router-link>
        </div>
        ...
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="bg-slate-800 rounded-lg p-8">
                ...
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-slate-100 mb-2">{{ report.title }}</h2>
