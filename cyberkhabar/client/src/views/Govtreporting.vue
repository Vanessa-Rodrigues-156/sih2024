<template>
    <div class="min-h-screen bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
        <div id="cyber-report-form" class="max-w-4xl mx-auto bg-gray-800 text-white rounded-lg p-5 shadow-lg">
            <header>
                <h1 class="text-center mb-2 text-cyan-400 text-2xl md:text-3xl lg:text-4xl font-bold">Report Cybersecurity Incident</h1>
            ...
            <form @submit.prevent="submitReport" class="mt-8 space-y-6">
                ...
                <button type="submit" class="w-full p-3 bg-cyan-500 rounded text-xl text-white hover:bg-cyan-600 transition-colors duration-300">Submit Report</button>
            </form>
            <footer class="text-center mt-8 text-xs md:text-sm text-gray-400">
                <p>© 2024 Cybersecurity Hub. Empowering a secure digital India.</p>
            </footer>
        </div>
    </div>
</template>
